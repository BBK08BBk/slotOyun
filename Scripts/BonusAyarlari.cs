...
public class BonusAyarlari : MonoBehaviour
{
    ...
    /// <summary>Açılacak panel: Inspector'da atanmışsa o, yoksa sahnede "BonusBuyConfirmPanel" veya "BonusSatinAlOnayPanel" adlı obje (kapalı olsa da bulunur), yoksa bu bileşenin GameObject'i.</summary>
    ...
    public void Goster(int maliyet, int bakiye, Action onEvetCallback, Action onHayirCallback)
    {
        ...
        while (t != null)
        {
            ...
            if (canvas != null) { canvas.sortingOrder = 9999; canvas.enabled = true; }
            t = t.parent;
        }
