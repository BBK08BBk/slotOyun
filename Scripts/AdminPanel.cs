...
public class AdminPanel : MonoBehaviour
{
    ...
    private void ZorlaCarpanButonlariniBagla()
    {
        ...
        if (zorlaCarpan5Button != null)
        {
            ...
            zorlaCarpan5Button.onClick.AddListener(() => ZorlaCarpanTıkla(100));
        }
        ...
        if (zorlaCarpan10Button != null)
        {
            ...
            zorlaCarpan10Button.onClick.AddListener(() => ZorlaCarpanTıkla(150));
        }
        ...
        if (zorlaCarpan50Button != null)
        {
            ...
            zorlaCarpan50Button.onClick.AddListener(() => ZorlaCarpanTıkla(250));
        }
        ...
        if (zorlaCarpan100Button != null)
        {
            ...
            zorlaCarpan100Button.onClick.AddListener(() => ZorlaCarpanTıkla(500));
        }
        ...
        foreach (Button b in butonlar)
        {
            ...
            else if (adi.Contains("carpan5") || adi.Contains("x5") || adi.Contains("carpan_5") || adi.Contains("forcex5") || adi.Contains("force_5"))
            {
                ...
                Debug.Log($"[ADMIN] Carpan100 (eski 5x) butonu bulundu: {b.gameObject.name}");
            }
            else if (adi.Contains("carpan10") || adi.Contains("x10") || adi.Contains("carpan_10") || adi.Contains("forcex10") || adi.Contains("force_10"))
            {
                b.onClick.RemoveAllListeners();
                b.onClick.AddListener(() => ZorlaCarpanTıkla(150));
                Debug.Log($"[ADMIN] Carpan150 (eski 10x) butonu bulundu: {b.gameObject.name}");
            }
            else if (adi.Contains("carpan50") || adi.Contains("x50") || adi.Contains("carpan_50") || adi.Contains("forcex50") || adi.Contains("force_50"))
            {
                b.onClick.RemoveAllListeners();
                b.onClick.AddListener(() => ZorlaCarpanTıkla(250));
                Debug.Log($"[ADMIN] Carpan250 (eski 50x) butonu bulundu: {b.gameObject.name}");
            }
            else if (adi.Contains("carpan100") || adi.Contains("x100") || adi.Contains("carpan_100") || adi.Contains("forcex100") || adi.Contains("force_100"))
            {
                b.onClick.RemoveAllListeners();
                b.onClick.AddListener(() => ZorlaCarpanTıkla(500));
                Debug.Log($"[ADMIN] Carpan500 (eski 100x) butonu bulundu: {b.gameObject.name}");
            }
    ...
    public void ZorlaCarpan10()
    {
        if (_oyunYoneticisi != null)
        {
            _oyunYoneticisi.zorlaSiradakiCarpan = 150;
            Debug.Log("[ADMIN] Zorla çarpan: x150");
        }
    }
    ...
    public void ZorlaCarpan50()
    {
        if (_oyunYoneticisi != null)
        {
            _oyunYoneticisi.zorlaSiradakiCarpan = 250;
            Debug.Log("[ADMIN] Zorla çarpan: x250");
        }
    }
    ...
    public void ZorlaCarpan100()
    {
        if (_oyunYoneticisi != null)
        {
            _oyunYoneticisi.zorlaSiradakiCarpan = 500;
            Debug.Log("[ADMIN] Zorla çarpan: x500");
        }
    }
