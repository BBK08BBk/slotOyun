...
public class TumbleServisi
{
    ...
    public IEnumerator TumbleLoop(Action<int> onKazanc) => _tumbleLoopImpl != null ? _tumbleLoopImpl(onKazanc) : null;

    public List<Vector2Int> FindClustersToRemove(int minSize)
    {
    ...
    public int CalculateWinForRemoved(List<Vector2Int> removed)
    {
    ...
    public IEnumerator CollapseRefillAndAnimate() => _collapseRefillAndAnimateImpl != null ? _collapseRefillAndAnimateImpl() : null;
    public IEnumerator AnimatePop(List<Vector2Int> cells) => _animatePopImpl != null ? _animatePopImpl(cells) : null;
}
