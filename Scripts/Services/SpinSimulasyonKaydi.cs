...
public class SpinSimulasyonKaydi
{
    ...
    /// <summary>Az daha near-miss: 3 scatter (bonus yok) veya bonus içinde büyük çarpan ama tumble yok. Panel gösterilir.</summary>
    public bool AzDahaNearMiss { get; set; }
}
